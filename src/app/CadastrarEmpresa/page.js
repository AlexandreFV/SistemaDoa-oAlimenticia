        ...
        <div className='DNCE' >
          <div className='DBNCE'>
            ...
            <div className="DFBCE">
              ...
              <form onSubmit={handleSubmit} className="formCadEmp1" style={{ display: activeButton === 1 ? 'block' : 'none' }}>
              ...
              <div>
                <form onSubmit={handleSubmit} className="formCadEmp2" style={{ display: activeButton === 2 ? 'block' : 'none' }}>
