...
export default function menuDoador(){
        ...
        return(
            ...
            <div style={{position:"relative",display:"inline-block",maxheight:"230px",maxwidth:"250px"}}>
                ...
                <div style={{ paddingTop: "15px",color:"white", paddingLeft:"10px",backgroundColor:"#7D9E65",
                ...
                <div style={{color:"white",backgroundColor:"#FEFEFE", top:-15,
                 width:"250px",height:"200px", borderBottomRightRadius:"20px",
                 position:"relative",zIndex:1 }}> 

                    <div style={{paddingTop:"40px"}}>
                        <CustomButton href={"/EnviarDoacao"} className={"btnn"} buttonText={"Fazer Doação"}/>
                    </div>

                    <div style={{paddingTop:"15px"}}>
                        <CustomButton href={"/MinhasDoacoes"} className={"btnn"} buttonText={"Minhas doações"}/>
                    </div>

                    <div style={{paddingTop:"15px"}}>
                        <CustomButton href={{}} className={"btnn"} buttonText={"Nível de classificação"}/>
                    </div>  
                </div>
            </div>
        )
