...
export default function layoutCadastroLogin(){
        ...
        return(
<nav className="navbar navbar-expand-lg" style={{backgroundColor: "rgba(120, 148, 74, 0.8)",height:"90px", 
...
<div style={{ position: 'fixed', top: 5, right: 30, marginTop: "15px" }}>
  <Link href="/"><button className="btn" style={{ color: "white" }}>Inicio</button></Link>
