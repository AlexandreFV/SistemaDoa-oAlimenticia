...
export default function EntrarIntermediario(){
    ...
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center",position:"absolute",left:0,marginLeft:"40px" }}>
      ...
      <Link href="/CadastrarIntermediario"><button className="btn" style={{ backgroundColor: "rgba(63, 173, 180, 0.87)", color: "white", width: "100px", height: "40px" }}>Cadastrar</button></Link>
    </div>
    ...
    <div style={{ color: "white", backgroundColor: "#578925", width: "430px", height: "500px", borderRadius: "10px", position: "absolute", right: 0, marginRight: "50px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
        <center>
        <h1 style={{ fontSize: "25px", marginTop: "30px", fontFamily: "Poller One cursive", fontWeight: "800" }}> Entrar como Intermediário</h1>
        </center>
