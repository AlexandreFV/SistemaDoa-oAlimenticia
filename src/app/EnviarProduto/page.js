...
export default function EnviarProduto() {
            ...
            <div className="DFCOLETARDOACAO">
                ...
                <div className="DICOLETARDOACAO">
                    <div className="DFPCOLETARDOACAO">
                        <BackButton />
                        <h1 className="h1MinDoaCOLETARDOACAO">Enviar produto doados</h1>
                        <div className="DFFCOLETARDOACAO">
                            <div style={{ display: "flex", alignItens: "center", textAlign: "center" }}>
                                <h1 style={{ display: "flex", justifyContent: "center", alignItems: "center", left: "1.6rem" }} className="h1ProdutosEnv">Produto disponiveis para -nome Beneficiario</h1>
