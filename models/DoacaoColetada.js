...
const doacaoColetada = sequelize.define('doacaoColetada', {
    nome_alimento: {
...
doacaoColetada.belongsTo(Doador); 
doacaoColetada.belongsTo(Intermediario); 
